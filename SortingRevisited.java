...
interface StatsTracking{
	...
	public static final String[] dataAnalysisOpts = {"Roster", "Players Grouped by Position", "Skaters Grouped by Shoots Direction", "Players Grouped by Country of Birth", "Skater's Goals", "Skater's Assists", "Skater's Points", "Skater's +/-", "Skater's Shots", "Skater's Shooting Percentage ", "Goalie's Shots Against", "Goalie's Goals Against", "Goalie's Saves", "Goalie's Save Percentage"};
...
class Output implements StatsTracking{
	...
	public void mainMenu(){
		...
		menuOptions(StatsTracking.dataAnalysisOpts, true);
		int choice = userChoice();
		switch(choice){
		case 1: r.printRoster(r.getRoster());
			break;
		//case 2: r.playerBios(r.getRoster());
		//	break;
		...
		case 4: FilterData.printLambdaBirthplaces(r.getRoster());
			break;
		case 5: FilterData.printSkaterStat(StatsTracking.skaterStats, 0, r.getRoster());
			break;
		case 6: FilterData.printSkaterStat(StatsTracking.skaterStats, 1, r.getRoster());
			break;
		case 7: FilterData.printSkaterStat(StatsTracking.skaterStats, 2, r.getRoster());
			break;
		case 8: FilterData.printSkaterStat(StatsTracking.skaterStats, 3, r.getRoster());
			break;
		case 9: FilterData.printSkaterStat(StatsTracking.skaterStats, 4, r.getRoster());
			break;
		case 10: FilterData.printSkaterStat(StatsTracking.skaterStats, 5, r.getRoster());
			break;
		case 11: FilterData.printGoalieStat(StatsTracking.goalieStats, 0, r.getRoster());
			break;
		case 12: FilterData.printGoalieStat(StatsTracking.goalieStats, 1, r.getRoster());
			break;
		case 13: FilterData.printGoalieStat(StatsTracking.goalieStats, 2, r.getRoster());
			break;
		case 14: FilterData.printGoalieStat(StatsTracking.goalieStats, 3, r.getRoster());
			break;
		case 15: selectYearMenu();
			break;
