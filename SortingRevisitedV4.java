...
interface RosterData{
	...
	GoalieStats holtbyStats2017 = new GoalieStats(153, 1495); //goals against, saves
	GoalieStats holtbyStats2016 = new GoalieStats(127, 1563);
	GoalieStats holtbyStats2015 = new GoalieStats(141, 1661);
	GoalieStats holtbyStats2014 = new GoalieStats(157, 1887);
	GoalieStats holtbyStats2013 = new GoalieStats(126, 1349);
	...
	GoalieStats grubauerStats2014 = new GoalieStats(2, 23);
	GoalieStats grubauerStats2013 = new GoalieStats(35, 434);
	...
	SkaterStats ovechkinStats2017 = new SkaterStats(49, 38, 3, 355); //goals, assists, plusMinus, shots
	SkaterStats ovechkinStats2016 = new SkaterStats(33, 36, 6, 313);
	SkaterStats ovechkinStats2015 = new SkaterStats(50, 21, 21, 398);
	SkaterStats ovechkinStats2014 = new SkaterStats(53, 28, 10, 395);
	SkaterStats ovechkinStats2013 = new SkaterStats(51, 28, -35, 386);
	...
	SkaterStats kuznetsovStats2014 = new SkaterStats(11, 26, 10, 127);
	SkaterStats kuznetsovStats2013 = new SkaterStats(3, 6, -2, 22);
	...
	SkaterStats backstromStats2014 = new SkaterStats(18, 60, 5, 153);
	SkaterStats backstromStats2013 = new SkaterStats(18, 61, -20, 196);
	...
	SkaterStats burakovskyStats2016 = new SkaterStats(12, 23, 13, 111);
	SkaterStats burakovskyStats2015 = new SkaterStats(17, 21, 4, 126);
	SkaterStats burakovskyStats2014 = new SkaterStats(9, 13, 12, 65);
	...
	SkaterStats wilsonStats2016 = new SkaterStats(7, 12, 9, 95);
	SkaterStats wilsonStats2015 = new SkaterStats(7, 16, 3, 99);
	SkaterStats wilsonStats2014 = new SkaterStats(4, 13, -1, 79);
	SkaterStats wilsonStats2013 = new SkaterStats(3, 7, 1, 63);
	
	HockeyPlayer carlson = new HockeyPlayer("Carlson", "Defense", "USA", "Right");
	SkaterStats carlsonStats2017 = new SkaterStats(15, 53, 0, 237);
	SkaterStats carlsonStats2016 = new SkaterStats(9, 28, 7, 180);
	SkaterStats carlsonStats2015 = new SkaterStats(8, 31, 16, 124);
	SkaterStats carlsonStats2014 = new SkaterStats(12, 43, 11, 193);
	SkaterStats carlsonStats2013 = new SkaterStats(10, 27, -3, 208);
	
	HockeyPlayer orlov = new HockeyPlayer("Orlov", "Defense", "Russia", "Left");
	SkaterStats orlovStats2017 = new SkaterStats(10, 21, 10, 125);
	SkaterStats orlovStats2016 = new SkaterStats(6, 27, 30, 125);
	SkaterStats orlovStats2015 = new SkaterStats(8, 21, 8, 90);
	SkaterStats orlovStats2014 = new SkaterStats(3, 8, -1, 59);
	SkaterStats orlovStats2013 = new SkaterStats(0, 1, 5, 1);
	
	HockeyPlayer orpik = new HockeyPlayer("Orpik", "Defense", "USA", "Left");
	SkaterStats orpikStats2017 = new SkaterStats(0, 10, -9, 54);
	SkaterStats orpikStats2016 = new SkaterStats(0, 14, 32, 93);
	SkaterStats orpikStats2015 = new SkaterStats(3, 7, 11, 31);
	SkaterStats orpikStats2014 = new SkaterStats(0, 19, 5, 66);
		...
		public static void seasonStats(ArrayList<HockeyPlayer> seasonRoster, String[] playersArray, String timePeriod, int choice){
			...
			if(r.isInRoster(playersArray[choice-1], seasonRoster) == true){
				...
				if(p.getPosition().equals("Goalie")){
					Goalie g = (Goalie)p;
					System.out.println("\t\t" + timePeriod + ": Shots Against: " + g.getStats().getShotsAgainst() + "\tGoals Against: " + g.getStats().getGoalsAgainst() + 
					"\tSaves: " + g.getStats().getSaves() + "\tSave Percentage: " + g.getStats().getSavePercentage());
				}
				else{
					Skater s = (Skater)p;
					System.out.println("\t\t" + timePeriod + ": Goals: " + s.getStats().getGoals() + "\tAssists: " + s.getStats().getAssists() +
					"\tPoints: " + s.getStats().getPoints() + "\t+/-: " + s.getStats().getPlusMinus() + "\tShots: " + s.getStats().getShots() + "\tShooting Percentage: " + s.getStats().getShootingPercentage());
				}
			}
		}
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class SortingRevisitedV4{
