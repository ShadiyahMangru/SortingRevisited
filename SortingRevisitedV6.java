...
interface StatsTracking{
	...
	public static final String[] sortSomeAllOpts = {"Show ALL skaters in sorted order", "Show 5 skaters with lowest scores", "Show 5 skaters with highest scores", "Define your own 'bracket'"};
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class GoalieStats{
	//fields
...
class Output implements StatsTracking{
	...
	public void skatersStatsMenu(){
		...
		switch(choice){
		case 1: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getGoals());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getGoals());
			...
			case 1: for(Skater sk : skaterStat)
				...
				break;
			case 2: ArrayList<Skater> lowestFive = new ArrayList<Skater>();
				for(int i = 0; i<5; i++){
					lowestFive.add(skaterStat.get(i));
				}
				for(Skater sk : lowestFive)
				System.out.println(sk + "'s " + StatsTracking.skaterStats[choice-1] + " : " + sk.getStats().getGoals()); 
				break;
			case 3: ArrayList<Skater> highestFive = new ArrayList<Skater>();
				for(int i = skaterStat.size() -1; i > skaterStat.size() - 6; i--){
					highestFive.add(skaterStat.get(i));
				}
				for(Skater sk : highestFive)
				System.out.println(sk + "'s " + StatsTracking.skaterStats[choice-1] + " : " + sk.getStats().getGoals()); 
				break;
			...
			break;
		case 2: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getAssists());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getAssists());
			menuOptions(StatsTracking.sortSomeAllOpts, false);
			sortChoice = userChoice();
			switch(sortChoice){
			case 1: for(Skater sk : skaterStat)
			...
			break;
		case 3: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getPoints());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getPoints());
			menuOptions(StatsTracking.sortSomeAllOpts, false);
			sortChoice = userChoice();
			switch(sortChoice){
			case 1: for(Skater sk : skaterStat)
			...
			break;
		case 4: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getPlusMinus());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getPlusMinus());
			menuOptions(StatsTracking.sortSomeAllOpts, false);
			sortChoice = userChoice();
			switch(sortChoice){
			case 1: for(Skater sk : skaterStat)
			...
			break;
		case 5: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getShots());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getShots());
			menuOptions(StatsTracking.sortSomeAllOpts, false);
			sortChoice = userChoice();
			switch(sortChoice){
			case 1: for(Skater sk : skaterStat)
			...
			break;
		case 6: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getShootingPercentage());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getShootingPercentage());
			menuOptions(StatsTracking.sortSomeAllOpts, false);
			sortChoice = userChoice();
			switch(sortChoice){
			case 1: for(Skater sk : skaterStat)
			...
			break;
		case 7: System.out.println("For " + getSeason() + " " + StatsTracking.skaterStats[choice-1]);
			System.out.println("MAX = " + skaterStat.get(skaterStat.size()-1).getStats().getAvgPtsGP());
			System.out.println("MIN = " + skaterStat.get(0).getStats().getAvgPtsGP());
			menuOptions(StatsTracking.sortSomeAllOpts, false);
			sortChoice = userChoice();
			switch(sortChoice){
			case 1: for(Skater sk : skaterStat)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
public class SortingRevisitedV6{
